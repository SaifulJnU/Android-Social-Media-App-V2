...
public class ProfileViewholder extends RecyclerView.ViewHolder {
    ...
    //ImageView imageView;
    TextView namell,vp_ll,namefollower, vpfolloewer,professionFollower;
    CardView cardView;
    ...
    public void setLikeduser(Application fragmentActivity, String name, String uid, String prof, String url){
    ...
    public void setFollower(Application application, String name,String url, String profession, String bio, String privacy, String email, String followers, String website)
    {
        ...
        vpfolloewer=itemView.findViewById(R.id.vp_follower);
