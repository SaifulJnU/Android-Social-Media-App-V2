...
public class UserLikedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(UserLikedActivity.this));
        ...
        FirebaseRecyclerAdapter<All_UserMmber,ProfileViewholder> firebaseRecyclerAdapter1 =
                new FirebaseRecyclerAdapter<All_UserMmber, ProfileViewholder>(options1) {
                    ...
                    protected void onBindViewHolder(@NonNull ProfileViewholder holder, int position, @NonNull All_UserMmber model) {
                        ...
                        holder.vpfolloewer.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                if(currentuid.equals(userid)){
                                    Intent intent = new Intent(UserLikedActivity.this,MainActivity.class);
                                    startActivity(intent);

                                }
                                Intent intent = new Intent(UserLikedActivity.this,ShowUser.class);
